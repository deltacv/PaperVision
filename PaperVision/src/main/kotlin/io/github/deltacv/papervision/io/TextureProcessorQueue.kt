// Refactored version of TextureProcessorQueue preserving full functionality.
// Cleaned structure, reduced duplication, improved readability, organized helpers.
...
class TextureProcessorQueue(
    ...
    override val idElementContainer: IdElementContainer<TextureProcessorQueue>
            by lazy { IdElementContainerStack.local.peekNonNull() }
