...
class Link(
    ...
    val attribIdElementContainer = IdElementContainerStack.local.peekNonNull<Attribute>()
    override val idElementContainer = IdElementContainerStack.local.peekNonNull<Link>()
    ...
    companion object {
        fun getLinksBetween(a: Node<*>, b: Node<*>): List<Link> {
            ...
            for(link in IdElementContainerStack.local.peekNonNull<Link>()) {
