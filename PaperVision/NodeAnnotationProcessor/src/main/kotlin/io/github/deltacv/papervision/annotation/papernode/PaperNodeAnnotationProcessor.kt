...
class PaperNodeAnnotationProcessor(
    ...
    private val packageName: String = environment.options["paperNodeClassesMetadataPackage"] ?: "io.github.deltacv.papervision.node.generated"
    private val fileName: String = environment.options["paperNodeClassesMetadataClassName"] ?: "PaperNodeAnnotationMetadata"

    private val paperNodeRegistryClass = ClassName(
        "io.github.deltacv.papervision.node",
        "PaperNodeRegistry"
    )
