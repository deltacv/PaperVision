...
class CodecTypeAnnotationProcessor(
    ...
    private val packageName: String = environment.options["codecTypeClassesMetadataPackage"] ?: "io.github.deltacv.papervision.serialization.v2.generated"
    private val fileName: String = environment.options["codecTypeClassesMetadataClassName"] ?: "CodecTypeAnnotationMetadata"

    private val codecTypeRegistryClass = ClassName(
        "io.github.deltacv.papervision.serialization.v2",
        "CodecTypeRegistry"
    )

    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver
            .getSymbolsWithAnnotation("io.github.deltacv.papervision.serialization.v2.CodecType")
